...
if (qr && mcode) {
  ...
  caption: `*⚽ ¡𝐓𝐮 𝐜ó𝐝𝐢𝐠𝐨 𝐝𝐞 𝐚𝐜𝐜𝐞𝐬𝐨 𝐞𝐬𝐭á 𝐥𝐢𝐬𝐭𝐨, 𝐩𝐢𝐥𝐨𝐭𝐨 𝐝𝐞 𝐍𝐚𝐠𝐢𝐁𝐨𝐭-𝐈𝐀! ⚽*\n\n𝐒𝐢𝐠𝐮𝐞 𝐞𝐬𝐭𝐞 𝐭𝐮𝐭𝐨𝐫𝐢𝐚𝐥 𝐩𝐚𝐬𝐨 𝐚 𝐩𝐚𝐬𝐨 𝐩𝐚𝐫𝐚 𝐯𝐢𝐧𝐜𝐮𝐥𝐚𝐫𝐭𝐞 𝐜𝐨𝐦𝐨 𝐒𝐮𝐛-𝐁𝐨𝐭 𝐝𝐞𝐬𝐝𝐞 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩:\n\n*①.* 𝐇𝐚𝐠𝐚 𝐜𝐥𝐢𝐜𝐤 𝐞𝐧 𝐥𝐨𝐬 𝟑 𝐩𝐮𝐧𝐭𝐨𝐬 𝐝𝐞 𝐥𝐚 𝐞𝐬𝐪𝐮𝐢𝐧𝐚 𝐝𝐞𝐫𝐞𝐜𝐡𝐚.\n*②.* 𝐒𝐞𝐥𝐞𝐜𝐜𝐢𝐨𝐧𝐚 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐫 𝐜𝐨𝐧 𝐄𝐥 𝐧ú𝐦𝐞𝐫𝐨 𝐝𝐞 𝐭𝐞𝐥𝐞𝐟𝐨𝐧𝐨.\n*③.* 𝐏𝐞𝐠𝐚 𝐞𝐥 𝐜ó𝐝𝐢𝐠𝐨 𝐞𝐧𝐯𝐢𝐚𝐝𝐨.\n\n*𝐂ó𝐝𝐢𝐠𝐨:* ${rawCode.match(/.{1,4}/g)?.join("-")}\n\n> 𝐓𝐨𝐜𝐚 𝐞𝐥 𝐛𝐨𝐭ó𝐧 𝐝𝐞 𝐚𝐛𝐚𝐣𝐨 𝐩𝐚𝐫𝐚 𝐜𝐨𝐩𝐢𝐚𝐫𝐥𝐨 𝐟á𝐜𝐢𝐥𝐦𝐞𝐧𝐭𝐞.`,
  title: "🔗 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐜𝐢ó𝐧 𝐞𝐧 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 - 𝐍𝐚𝐠𝐢𝐁𝐨𝐭-𝐈𝐀",
