...
if (qr && mcode) {
  ...
  caption: `*⚽ ¡𝐓𝐮 𝐜ó𝐝𝐢𝐠𝐨 𝐝𝐞 𝐚𝐜𝐜𝐞𝐬𝐨 𝐞𝐬𝐭á 𝐥𝐢𝐬𝐭𝐨, 𝐩𝐢𝐥𝐨𝐭𝐨 𝐝𝐞 𝐍𝐚𝐠𝐢𝐁𝐨𝐭-𝐈𝐀! ⚽*\n\n𝐒𝐢𝐠𝐮𝐞 𝐞𝐬𝐭𝐞 𝐭𝐮𝐭𝐨𝐫𝐢𝐚𝐥 𝐩𝐚𝐬𝐨 𝐚 𝐩𝐚𝐬𝐨 𝐩𝐚𝐫𝐚 𝐯𝐢𝐧𝐜𝐮𝐥𝐚𝐫𝐭𝐞 𝐜𝐨𝐦𝐨 𝐒𝐮𝐛-𝐁𝐨𝐭:\n\n*①.* 𝐂𝐨𝐩𝐢𝐚 𝐞𝐥 𝐜ó𝐝𝐢𝐠𝐨 𝐪𝐮𝐞 𝐯𝐞𝐬 𝐚𝐛𝐚𝐣𝐨.\n*②.* 𝐀𝐛𝐫𝐞 𝐭𝐮 𝐓𝐞𝐫𝐦𝐮𝐱 𝐨 𝐞𝐧𝐭𝐨𝐫𝐧𝐨 𝐝𝐞 𝐞𝐣𝐞𝐜𝐮𝐜𝐢ó𝐧.\n*③.* 𝐄𝐬𝐜𝐫𝐢𝐛𝐞 𝐞𝐥 𝐜𝐨𝐦𝐚𝐧𝐝𝐨: \`code ${rawCode.match(/.{1,4}/g)?.join("-")}\`\n*④.* 𝐄𝐬𝐩𝐞𝐫𝐚 𝐪𝐮𝐞 𝐞𝐥 𝐛𝐨𝐭 𝐜𝐫𝐞𝐞 𝐭𝐮 𝐬𝐞𝐬𝐢ó𝐧.\n*⑤.* 𝐔𝐧𝐚 𝐯𝐞𝐳 𝐯𝐢𝐧𝐜𝐮𝐥𝐚𝐝𝐨, 𝐩𝐨𝐝𝐫á𝐬 𝐮𝐬𝐚𝐫 𝐜𝐨𝐦𝐚𝐧𝐝𝐨𝐬 𝐝𝐞𝐬𝐝𝐞 𝐭𝐮 𝐧ú𝐦𝐞𝐫𝐨.\n\n*𝐂ó𝐝𝐢𝐠𝐨:* ${rawCode.match(/.{1,4}/g)?.join("-")}\n\n> 𝐓𝐨𝐜𝐚 𝐞𝐥 𝐛𝐨𝐭ó𝐧 𝐝𝐞 𝐚𝐛𝐚𝐣𝐨 𝐩𝐚𝐫𝐚 𝐜𝐨𝐩𝐢𝐚𝐫𝐥𝐨 𝐟á𝐜𝐢𝐥𝐦𝐞𝐧𝐭𝐞.`,
  title: "🔗 𝐂ó𝐝𝐢𝐠𝐨 𝐝𝐞 𝐕𝐢𝐧𝐜𝐮𝐥𝐚𝐜𝐢ó𝐧 - 𝐍𝐚𝐠𝐢𝐁𝐨𝐭-𝐈𝐀",
  footer: "⏳ 𝐄𝐬𝐭𝐞 𝐜ó𝐝𝐢𝐠𝐨 𝐞𝐱𝐩𝐢𝐫𝐚𝐫á 𝐞𝐧 𝟒𝟓 𝐬𝐞𝐠𝐮𝐧𝐝𝐨𝐬.",
  interactiveButtons
};
...
? await conn.sendMessage(
      ...
      {
        text: args[0]
? `@${m.sender.split('@')[0]}, 🍂 *_Ya estás conectado, leyendo mensajes entrantes..._*`
: `@${m.sender.split('@')[0]}, 🌿 *_Genial ya eres parte de nuestra familia de Sub-Bots._*`,
        mentions: [m.sender]
},
      { quoted: message, rcanal}
)
: '';
