...
let handler = async (message, { conn, text, usedPrefix, command }) => {
    if (!text) return conn.reply(message.chat, '🍃 *Escriebe algo para buscar en tiktoks*', message, rcanal);
    ...
    try {
        ...
        conn.reply(message.chat, '🍃 *Descarado sus videos Espere...*', message, rcanal);
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({ text: '🔎 Nagi - Resultados'}),
